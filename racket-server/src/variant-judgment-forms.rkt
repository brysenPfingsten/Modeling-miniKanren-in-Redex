...
(define (lvars-subset/rkt? small big)
  (andmap (lambda (u) (member u big)) small))
...
(define-judgment-form
  L4
  #:contract (wf-goal/L4? g ((r d_env g_env) ...) (x ...) c)
...
(define-judgment-form
  ...
  [(side-condition ,(lvars-subset/rkt? (term c) (term c_i)))
