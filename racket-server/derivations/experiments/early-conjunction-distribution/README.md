# Early conjunction distribution experiment
...
The experiment reuses the earlier dormant-branch languages, kernels, owner operations,
...
```sh
raco test racket-server/derivations/experiments/early-conjunction-distribution/tests.rkt
```
