...
```sh
raco test racket-server/derivations/strict-search/matrix/stages/tests.rkt
raco test racket-server/derivations/strict-search/matrix/stages/domain-tests.rkt
raco test racket-server/derivations/strict-search/matrix/stages/commit-tests.rkt
```
