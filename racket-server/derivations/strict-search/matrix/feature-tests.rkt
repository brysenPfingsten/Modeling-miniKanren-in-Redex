...
(module+ test
  ...
  (test-case "pending prefix is strict Search work owned by Delay features"
    ...
    (check-equal? (list (redex-match? StrictNCore q n) (redex-match? StrictNDelay q n)
                  ...
                  '(#f #t #f #t))
    (check-true (redex-match? StrictSDelay E (term (prefix (Owners) hole))))
    (check-true (redex-match? StrictEDelay E (term (prefix hole))))
    (check-true (redex-match? StrictNDelay E (term (prefix hole))))
