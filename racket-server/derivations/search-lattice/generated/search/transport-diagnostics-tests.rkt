...
(provide GENERATED-SEARCH-TRANSPORT-DIAGNOSTICS-TESTS)
...
(define-diagnostic-row
  ...
  stage-s:search/delay-stage-extension/S/D-plug-D
  stage-s:search/delay-stage-extension/S/Z-refocus-phase
  diag-s:search/delay-stage-extension/S/diagnostic-D->Z
  diag-s:search/delay-stage-extension/S/diagnostic-Z->D
  diag-s:search/delay-stage-extension/S/diagnostic-readback-Z
  stage-s:search/delay-stage-extension/S/Z-step
  diag-s:search/delay-stage-extension/S/diagnostic-Z-step
  stage-s:search/delay-stage-extension/S/M-machineize
  diag-s:search/delay-stage-extension/S/diagnostic-encode-ZM
  diag-s:search/delay-stage-extension/S/diagnostic-decode-MZ
  diag-s:search/delay-stage-extension/S/diagnostic-readback-M
  diag-s:search/delay-stage-extension/S/diagnostic-ZM-corresponds
  stage-s:search/delay-stage-extension/S/M-step
  diag-s:search/delay-stage-extension/S/diagnostic-M-step
  diag-s:search/delay-stage-extension/S/diagnostic-ZM-square
  stage-s:search/delay-stage-extension/S/B-compress
  diag-s:search/delay-stage-extension/S/diagnostic-encode-MB
  diag-s:search/delay-stage-extension/S/diagnostic-decode-BM
  diag-s:search/delay-stage-extension/S/diagnostic-readback-B
  diag-s:search/delay-stage-extension/S/diagnostic-MB-corresponds
  diag-s:search/delay-stage-extension/S/diagnostic-replay-M
  stage-s:search/delay-stage-extension/S/B-step
  diag-s:search/delay-stage-extension/S/diagnostic-B-step
  diag-s:search/delay-stage-extension/S/diagnostic-MB-square
  stage-s:search/delay-stage-extension/S/B-span-labels
  stage-s:search/delay-stage-extension/S/Big-evaluate
  diag-s:search/delay-stage-extension/S/diagnostic-initialize-B
  stage-s:search/delay-stage-extension/S/Big-promote
  diag-s:search/delay-stage-extension/S/diagnostic-Big-evaluate
  diag-s:search/delay-stage-extension/S/diagnostic-close-B
  diag-s:search/delay-stage-extension/S/diagnostic-flatten-BTrace
  diag-s:search/delay-stage-extension/S/diagnostic-readback-Big
  diag-s:search/delay-stage-extension/S/diagnostic-B-Big-unfold
  diag-s:search/delay-stage-extension/S/diagnostic-B-Big-closure
  diag-s:search/delay-stage-extension/S/diagnostic-B-Big-root)

(define-diagnostic-row
  ROW/E 'E SEARCH-CORPUS/E
  stage-e:search/delay-stage-extension/E/D-decompose
  stage-e:search/delay-stage-extension/E/D-plug-D
  stage-e:search/delay-stage-extension/E/Z-refocus-phase
  diag-e:search/delay-stage-extension/E/diagnostic-D->Z
  diag-e:search/delay-stage-extension/E/diagnostic-Z->D
  diag-e:search/delay-stage-extension/E/diagnostic-readback-Z
  stage-e:search/delay-stage-extension/E/Z-step
  diag-e:search/delay-stage-extension/E/diagnostic-Z-step
  stage-e:search/delay-stage-extension/E/M-machineize
  diag-e:search/delay-stage-extension/E/diagnostic-encode-ZM
  diag-e:search/delay-stage-extension/E/diagnostic-decode-MZ
  diag-e:search/delay-stage-extension/E/diagnostic-readback-M
  diag-e:search/delay-stage-extension/E/diagnostic-ZM-corresponds
  stage-e:search/delay-stage-extension/E/M-step
  diag-e:search/delay-stage-extension/E/diagnostic-M-step
  diag-e:search/delay-stage-extension/E/diagnostic-ZM-square
  stage-e:search/delay-stage-extension/E/B-compress
  diag-e:search/delay-stage-extension/E/diagnostic-encode-MB
  diag-e:search/delay-stage-extension/E/diagnostic-decode-BM
  diag-e:search/delay-stage-extension/E/diagnostic-readback-B
  diag-e:search/delay-stage-extension/E/diagnostic-MB-corresponds
  diag-e:search/delay-stage-extension/E/diagnostic-replay-M
  stage-e:search/delay-stage-extension/E/B-step
  diag-e:search/delay-stage-extension/E/diagnostic-B-step
  diag-e:search/delay-stage-extension/E/diagnostic-MB-square
  stage-e:search/delay-stage-extension/E/B-span-labels
  stage-e:search/delay-stage-extension/E/Big-evaluate
  diag-e:search/delay-stage-extension/E/diagnostic-initialize-B
  stage-e:search/delay-stage-extension/E/Big-promote
  diag-e:search/delay-stage-extension/E/diagnostic-Big-evaluate
  diag-e:search/delay-stage-extension/E/diagnostic-close-B
  diag-e:search/delay-stage-extension/E/diagnostic-flatten-BTrace
  diag-e:search/delay-stage-extension/E/diagnostic-readback-Big
  diag-e:search/delay-stage-extension/E/diagnostic-B-Big-unfold
  diag-e:search/delay-stage-extension/E/diagnostic-B-Big-closure
  diag-e:search/delay-stage-extension/E/diagnostic-B-Big-root)

(define-diagnostic-row
  ROW/N 'N SEARCH-CORPUS/N
  stage-n:search/delay-stage-extension/N/D-decompose
  stage-n:search/delay-stage-extension/N/D-plug-D
  stage-n:search/delay-stage-extension/N/Z-refocus-phase
  diag-n:search/delay-stage-extension/N/diagnostic-D->Z
  diag-n:search/delay-stage-extension/N/diagnostic-Z->D
  diag-n:search/delay-stage-extension/N/diagnostic-readback-Z
  stage-n:search/delay-stage-extension/N/Z-step
  diag-n:search/delay-stage-extension/N/diagnostic-Z-step
  stage-n:search/delay-stage-extension/N/M-machineize
  diag-n:search/delay-stage-extension/N/diagnostic-encode-ZM
  diag-n:search/delay-stage-extension/N/diagnostic-decode-MZ
  diag-n:search/delay-stage-extension/N/diagnostic-readback-M
  diag-n:search/delay-stage-extension/N/diagnostic-ZM-corresponds
  stage-n:search/delay-stage-extension/N/M-step
  diag-n:search/delay-stage-extension/N/diagnostic-M-step
  diag-n:search/delay-stage-extension/N/diagnostic-ZM-square
  stage-n:search/delay-stage-extension/N/B-compress
  diag-n:search/delay-stage-extension/N/diagnostic-encode-MB
  diag-n:search/delay-stage-extension/N/diagnostic-decode-BM
  diag-n:search/delay-stage-extension/N/diagnostic-readback-B
  diag-n:search/delay-stage-extension/N/diagnostic-MB-corresponds
  diag-n:search/delay-stage-extension/N/diagnostic-replay-M
  stage-n:search/delay-stage-extension/N/B-step
  diag-n:search/delay-stage-extension/N/diagnostic-B-step
  diag-n:search/delay-stage-extension/N/diagnostic-MB-square
  stage-n:search/delay-stage-extension/N/B-span-labels
  stage-n:search/delay-stage-extension/N/Big-evaluate
  diag-n:search/delay-stage-extension/N/diagnostic-initialize-B
  stage-n:search/delay-stage-extension/N/Big-promote
  diag-n:search/delay-stage-extension/N/diagnostic-Big-evaluate
  diag-n:search/delay-stage-extension/N/diagnostic-close-B
  diag-n:search/delay-stage-extension/N/diagnostic-flatten-BTrace
  diag-n:search/delay-stage-extension/N/diagnostic-readback-Big
  diag-n:search/delay-stage-extension/N/diagnostic-B-Big-unfold
  diag-n:search/delay-stage-extension/N/diagnostic-B-Big-closure
  diag-n:search/delay-stage-extension/N/diagnostic-B-Big-root)
...
(define (check-barrier-diagnostics row source)
  ;; A WF scheduler barrier is outside the horizontal carrier domain.  There
  ;; is no D from which a Z, M, or B diagnostic square could truthfully be
  ;; queried; the positive representatives above own those square checks.
  (check-equal? ((diagnostic-row-decompose row) source) '())
  (check-equal? ((diagnostic-row-big-evaluate row) source) '()))

(define GENERATED-SEARCH-TRANSPORT-DIAGNOSTICS-TESTS
  (test-suite
   "secondary generated Search codec and readback diagnostics"

   (test-case "all twenty-one representatives agree with secondary transports"
     (for ([row (in-list ROWS)])
       (for ([pair
              (in-list
               (search-row-corpus-rule-sources
                (diagnostic-row-corpus row)))])
         (check-diagnostics row (second pair)))))

   (test-case "all eight mixed-feature witnesses agree with secondary transports"
     (for ([row (in-list ROWS)])
       (define mixed
       ...
       (for ([case (in-list mixed)])
         (check-diagnostics row (search-mixed-case-source case)))))

   (test-case "the scheduler barrier enters no diagnostic carrier or Big"
     (for ([row (in-list ROWS)])
       (check-barrier-diagnostics
        row
        (search-row-corpus-scheduler-barrier
         (diagnostic-row-corpus row)))))

   (test-case "three bounded mixed diagnostics retain exact BTrace evidence"
     (for ([row (in-list ROWS)])
       (for ([trace-case
              (in-list
         ...
         (define expected-spans (search-trace-case-spans trace-case))
...
(module+ test
  (run-tests GENERATED-SEARCH-TRANSPORT-DIAGNOSTICS-TESTS))
