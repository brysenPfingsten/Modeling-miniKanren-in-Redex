...
(require rackunit redex/reduction-semantics
         ...
         (prefix-in base: "../../src/search-lattice/languages/search-relcall-lang.rkt")
         (prefix-in wf: "../../src/search-lattice/wf/all.rkt")
         "../../src/sexpr-read.rkt"
         (only-in "../../src/transpiler.rkt" parse-prog/canonical)
         (prefix-in strict: "../strict-search/matrix/full-source.rkt")
         (prefix-in lattice: "../../src/search-lattice/languages/rail-relcall-lang.rkt")
         (prefix-in direct: "../strict-search/retained-scope/interpreter.rkt")
         (prefix-in online: "interpreter.rkt")
         (prefix-in source: "source.rkt")
         (only-in "../strict-search/shared/kernel.rkt"
                  owners-support owners-append named-variable?)
         (only-in "../strict-search/shared/maps.rkt" Q-SE Q-SN)
         "../strict-search/test-support/witnesses.rkt")
...
(define (delay goal) `(suspend ,goal (label "delay")))
...
(module+ test
  ...
  (test-case "left delay changes work timing even when Strict and interleaving final Frontiers agree"
    (define goal (disj (delay (atom "A")) (atom "B")))
    (define executions
  ...
  (test-case "guarded DFS repeats its left-priority shape; other schedulers expose the finite sibling"
    ...
    (define definitions `((r:loop () ,(delay call))))
